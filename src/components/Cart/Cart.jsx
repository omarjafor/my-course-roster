const Cart = ({ selectedCourse, totalCredit, totalPrice, remaining }) => {
    return (
        <div>
            <div className="md:ml-0 lg:ml-6 shadow-lg rounded-xl bg-[#FFF] p-6 md:w-[312px] lg:w-auto">
                <h2 className="text-lg text-[#2F80ED] font-bold pb-4 border-b border-solid border-[#11111126]">Credit Hour Remaining {remaining} hr</h2>
                ...
                <h2 className="text-[#1C1B1BCC] font-semibold pb-4 mt-4">Total Price : {totalPrice} USD</h2>
            </div>
        </div>
    );
};

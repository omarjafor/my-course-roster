const Cart = () => {
    return (
        <div>
            <div className="md:ml-0 lg:ml-6 shadow-lg bg-[#FFF] p-6">
                ...
                <div className="font-medium text-2xl leading-[48px] mt-4 pb-6 border-b border-solid border-[#11111126]">
                    ...
                    <li className="list-decimal text-base text-[#1C1B1B99]">Introduction to C Programming</li>
                    <li className="list-decimal text-base text-[#1C1B1B99]">Introduction to C Programming</li>
                    <li className="list-decimal text-base text-[#1C1B1B99]">Introduction to C Programming</li>
                </div>
                <h2 className="text-[#1C1B1BCC] font-semibold pb-4 mt-4 border-b border-solid border-[#11111126]">Total Credit Hour : 13</h2>
